...
let questionView = () => {
    ...
    questionDiv.html(questions[questionIdx].label);

    video.on("ended", 
        () => {
            questionDiv.html(
                questions[questionIdx].label+"<br>"
                +questions[questionIdx].debut+"<br>"
                +questions[questionIdx].finA+"<br>"
                +questions[questionIdx].finB);
...
let answerView = () => {
    ...
    let questionDiv = $('<div id="question"></div>');
    questionDiv.addClass('questionClass');
    questionDiv.html(questions[questionIdx].label+"<br>"+questions[questionIdx].debut);
    ...
    headerTrue.text(questions[questionIdx].finA);
    ...
    headerFalse.text(questions[questionIdx].finB);
...
let questions= [
    ...
    {label:"Julien Doré - Le lac", debut:"Font ...", finA:"A-une belle rime", finB:"B-prendre racine", answer:false},
